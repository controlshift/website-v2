...
* Make sure that you've added links to your donation tool to your ControlShift header and footer. ControlShift's [Themes features](https://support.controlshiftlabs.com/article/102-customizing-your-site-with-themes) can also be useful in allowing you to designate different donation page destinations for different types of actions (e.g. if you have a specific donation page in support of a day of action, you can make sure that donation page is linked on the event page headers).

* It’s also possible to [ask for donations after someone signs a ControlShift petition](https://support.controlshiftlabs.com/article/150-donations-in-controlshift). By asking immediately, they’ll still have the tangible example of your important impact in their minds when they’re asked. To implement this flow, you have a few options:
