...
* It’s also possible to [ask for donations after someone signs a ControlShift petition](https://support.controlshiftlabs.com/hc/en-us/articles/360000152275). By asking immediately, they’ll still have the tangible example of your important impact in their minds when they’re asked. To implement this flow, you have a few options:
  ...
  * ControlShift has a welcome modal that allows organizations to introduce the organization and the work they're doing. This can be especially helpful for newly-identified supporters who may be less familiar with your organization’s work. The welcome modal can be configured to include a donation button that redirects to an offsite donation form. 
...
* You can add a donation ask to the thank you for signing/RSVPing emails that we send to supporters. You could also add an ask to the reminder emails that are sent to attendees before their upcoming events. ControlShift also supports conditional logic for text blocks, which allows you to do things like limit donation asks to only the petitions that have been given the highest approval by your moderators. 
